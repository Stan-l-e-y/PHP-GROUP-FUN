...
<body>
    ...
    <div class="mt-10 mb-10 mx-auto max-w-sm pl-6"><a href="/notifications" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">Go Back</a></div>
</body>

...
<body>
    <div class="border border-gray-200 p-6 rounded-xl max-w-sm mx-auto mt-10">
        <form action="/clientnotifications" method="POST">
    ...
    <div class="mt-10 mb-10 mx-auto max-w-sm pl-6"><a href="/clientnotifications" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">Go Back</a></div>
</body>
